$(document).ready(function () {
    ...
    function startup() {
        ...
        var lastCity = last[last.length - 1];
        console.log("this was last city's weather that was requested: " + lastCity);

        var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + lastCity + "&units=imperial&appid=" + APIkey;
        ...
        // =======Varibles=======
        var lastCityFive = last[last.length - 1];
        console.log("this was last city's weather that was requested: " + lastCityFive);
        var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + lastCityFive + "&units=imperial&appid=" + APIkey;
        var m = 0;
        var n = 0;
        var o = 4;
        var p = 0;
